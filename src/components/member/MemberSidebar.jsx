...
const MENU_GROUPS = [
  ...
  },
  {
    ...
    children: [
      ...
      { to: "/feed?filter=ms", label: "MS Updates" },
      { to: "/feed?filter=events", label: "Events & Notices" },
      { to: "/feed?filter=sponsored", label: "Sponsored Posts" },
    ],
  },
  {
    id: "OFFERS",
    ...
    icon: Gift,
    children: [
      { to: "/offers", label: "Featured Offers" },
      { to: "/offers#categories", label: "Categories Grid" },
      { to: "/offers#coupons", label: "Coupons & Deals" },
    ],
  },
  {
    id: "EXPLORE",
    ...
    icon: Search,
    children: [
      { to: "/explore", label: "Universal Directory" },
      { to: "/temples", label: "Temples & Derasars" },
      { to: "/explore?cat=jaincenter", label: "Jain Centres" },
      { to: "/ms", label: "Maharaj Saheb (MS)" },
      { to: "/explore?cat=dharamshala", label: "Dharamshalas" },
      { to: "/explore?cat=bhojanshala", label: "Bhojanshalas" },
      { to: "/news", label: "Today's News" },
      { to: "/events", label: "Events & Programs" },
      { to: "/tours", label: "Tours & Yatras" },
      { to: "/spiritual", label: "Spiritual Tools" },
    ],
  },
  {
    id: "PROFILE",
    ...
    icon: User,
    children: [
      { to: "/profile", label: "Personal Profile" },
      { to: "/digital-id", label: "Digital ID & QR" },
      { to: "/wallet", label: "My Digital Wallet" },
      { to: "/bookings", label: "My Bookings & Tickets" },
      { to: "/donations", label: "My Donations" },
      { to: "/notifications", label: "Notifications History" },
      { to: "/support", label: "Support & Help Desk" },
    ],
  },
];
